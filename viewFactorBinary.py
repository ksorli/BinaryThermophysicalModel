...
NOTE: Currently calculates the view factors for each individual body separately. 
"""
...
print ("Size of result: {}".format(np.shape(res)))

###############################################################################
## Save to .npy file with memory map capabilities
###############################################################################
np.save(binaryVFFile, res)
